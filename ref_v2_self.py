...
from models import RefV2 as Model
...
model_name = 'ref_v2_self_65'
work_dir = f'work_dirs/{model_name}'
load_from = None  # 'work_dirs/ref_v1/weights/best.pth'


def train(
        load_from=None,
        in_path='data/field_data/field_data.mat',
        out_path='data/field_data/field_ref_v2_65.mat'):
